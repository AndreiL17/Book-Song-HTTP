...
@Getter
@Setter
public class AlbumReview implements toJSON, toCSV {
    @Id
     ...
     *
     * @param albumId  The ID of the album being reviewed.
     ...
     */
    public AlbumReview(int albumId, float rating, String comment, Date date) {
